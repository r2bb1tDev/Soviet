...
Soviet Messenger (v2.3) построен на **Tauri 2** с Rust-бэкенд и React/TypeScript-фронтенд. Это децентрализованный мессенджер с поддержкой:
...
В v2.3 только русский язык. Поддержка i18n планируется в будущих версиях.
...
GitHub Actions автоматически собирает бинарники при создании тага (`v2.3.0`):
